    ...
    <RevealOnScroll className="group grid grid-cols-1 items-center gap-8 border-t border-border py-14 first:border-t-0 md:grid-cols-2 md:gap-14">
      ...
      <div className={reverse ? "md:order-1" : ""}>
        <div className="flex items-center gap-3">
          <span className="font-mono text-xs text-fg-faint">0{index}</span>
...
export function BuildCard({ project }: { project: Project }) {
  return (
    <RevealOnScroll className="group relative flex flex-col gap-4 rounded-lg border border-border bg-bg-raised p-6 transition-colors hover:border-border-strong">
